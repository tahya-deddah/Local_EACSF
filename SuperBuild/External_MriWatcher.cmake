...
if(NOT ( DEFINED "USE_SYSTEM_${extProjName}" AND "${USE_SYSTEM_${extProjName}}" ) )
  ...
  set(${proj}_CMAKE_OPTIONS
      ...
      -DMriWatcher_LEGACY_REMOVE:BOOL=OFF
      -DMriWatcher_FUTURE_LEGACY_REMOVE:BOOL=OFF
      -DMriWatcher_COMPATIBILITY:BOOL=OFF
      -DMriWatcher_USE_REVIEW:BOOL=ON
      -DMriWatcher_WRAP_PYTHON:BOOL=OFF
      -DModule_MriWatcherReview:BOOL=ON
      -DModule_MriWatcherIODCMTK:BOOL=ON
      -DModule_MGHIO:BOOL=ON
      -DV_BUILD_DEFAULT_MODULES:BOOL=ON
      -DKWSYS_USE_MD5:BOOL=ON # Required by SlicerExecutionModel
      -DMriWatcher_WRAPPING:BOOL=OFF #${BUILD_SHARED_LIBS} ## HACK:  QUICK CHANGE
      -DITK_DIR:PATH=${ITK_DIR}
    )
  ### --- End Project specific additions
  set(${proj}_REPOSITORY https://github.com/NIRALUser/MriWatcher.git)
...
## We really do want to install in order to limit # of include paths INSTALL_COMMAND ""
 ...
 set(${extProjName}_DIR ${CMAKE_BINARY_DIR}/${proj}-build)
  ...
  if(${USE_SYSTEM_${extProjName}})
    find_package(${extProjName} ${MriWatcher_VERSION_MAJOR} REQUIRED)
